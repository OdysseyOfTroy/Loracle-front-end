...
function NewCategoryModal(props, setname={setname}, setDescription={setDescription}) {
      ...
      <Modal.Body>  
        <form>
          <div className="form-group">
            <label for="name-label" className="col-form-label">Name:</label>
            <input type="text" className="form-control" id="title-name" onChange={(e) => props.setName(e.target.value)}/>
          </div>
          <div className="form-group">
